...
#'    \item{Alt.Hill}{Apparent altitude of hill towards which the Stone Rows are pointing}
#'    \item{Dec.Hill}{Topocentric declination of hill towards which the Stone Rows are pointing}
#'    }
#' @keywords datasets
